...
public class AreaAddfragment extends Fragment {
    ...
    public AreaAddfragment() {
    }

    private static AreaAddfragment areaAddfragment;

    public static AreaAddfragment getInstance() {
        if (areaAddfragment == null) {
            areaAddfragment = new AreaAddfragment();
        }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mView == null) {
            L.i("AreaAddfragment  onCreateView");
            mView = inflater.inflate(R.layout.fragment_area_add, container,
                    false);

        } else {
            L.i("AreaAddfragment   no  onCreateView");
        }
        findView();
        setlistener();
    ...
    private void postAreaAdd() {
        ...
        PostAreaAddParam param = new PostAreaAddParam();
...
//        L.i("json","json:"+json);
        ...
        ConnectManager.getInstance().PostAreaAdd(param, json, callback);
