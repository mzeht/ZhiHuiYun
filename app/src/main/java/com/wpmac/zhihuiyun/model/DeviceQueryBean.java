 ...
 */
public class DeviceQueryBean extends ResponseBean {
    ...
    public static DeviceQueryBean deviceQueryBean(String josnStr)
        ...
        Gson gson = new Gson();
        DeviceQueryBean model = new DeviceQueryBean();
        JSONObject singleObject = new JSONObject(josnStr);
        model = gson.fromJson(singleObject.toString(), DeviceQueryBean.class);
        return model;
    }
